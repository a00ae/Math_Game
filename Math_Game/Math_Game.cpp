...
//using namespace std;
////مستوى الاسئلة
//enum enQuestionLevel {Easy=1, Med=2, Hard=3, MixLev=4};
//// ماهي الاسئلة التي تنوي الاختبار بها
//enum enOpertionType {Add=1, Sub=2, Mul=3, Div=4, MixOper=5};
//
//
//struct stQuestion
//{
...
//    int number;
//    do {
//        cout << "How many questions do you intend to answer?" << endl;
//        cin >> number;
//    } while (number <= 0);
//    return number;
//}
//
//// تغير حالة العمليات الحسابية عشوائياً
//enOpertionType GetRandomOperationType()
//{
//    return (enOpertionType)RandomNumber(1, 4);
//}
//
//
//void SetScreenColor(bool Right)
...
//
//    if(OpType == enOpertionType::MixOper)
//        OpType = GetRandomOperationType();
//
//    Question.OperationType = OpType;
//
...
//    Quizz.OpType = enOpertionType::MixOper;
//
//    for (short QuestionnsNumber = 0; QuestionnsNumber < Quizz.NumberOfQuestions; QuestionnsNumber++) {
//        Quizz.QuestionList[QuestionnsNumber] = generateQuestion(Quizz.QuestionsLevel, Quizz.OpType);
//    }
//
//    AskAndCorrectQuestionListAnswers(Quizz);
//
